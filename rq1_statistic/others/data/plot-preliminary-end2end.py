...
def plot_fps_stream_number(type):
    ...
    for i in range(len(axes)):
        ...
        ax[i].set_xlabel(xlabels_fig[i], size=38,labelpad=30)
    ...
    labels = ["CV1", "CV2", "NLP"]
    ax[0].legend( bars, labels, fontsize=32,ncol=3, loc="lower left", bbox_to_anchor=(-0.1, 0.95),frameon=False,columnspacing = 1.0,handletextpad=0.3)
